...
Vue.component('admin-edit-checkbox', __webpack_require__(/*! ./components/Checkbox.vue */ "./resources/js/components/Checkbox.vue")["default"]);
/**
...
__webpack_require__(/*! ./krpz/main */ "./resources/js/krpz/main.js");
...
if (window.location.pathname === '/karapuzy/participate') {
  var updateImageDisplay = function updateImageDisplay() {
    ...
    if (curFiles.length === 0) {
      ...
      var len = curFiles.length < 3 ? curFiles.length : 3;
      ...
      for (var i = 0; i < len; i++) {
        ...
        if (validSize(curFiles[i])) {
          _para.textContent = 'Имя файла ' + curFiles[i].name + ', размер ' + returnFileSize(curFiles[i].size) + '.';
          ...
          _para.textContent = 'Имя файла ' + curFiles[i].name + ': Загружаемое изображение больше 5MB';
          listItem.appendChild(_para);
        }
...
__webpack_require__(/*! /srv/src/photocontest/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /srv/src/photocontest/resources/sass/app.sass */"./resources/sass/app.sass");
