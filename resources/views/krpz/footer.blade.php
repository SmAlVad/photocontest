<footer class="contact"  data-aos="fade-up" data-aos-duration="400">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-2 col-6">
                <div class="footer-block">
                    ...
                    <ul class="footer-block-list">
                        <li>
                            <a href="{{ route('krpz-about') }}">О конкурсе</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-xl-2 col-6">
                <div class="footer-block">
                    ...
                    <div class="footer-social">
                        ...
                        <div class="footer-social-item" style="align-items: center;">
        ...
        <div class="row justify-content-center">
            <div class="col-xl-12 pt-3">
                <div class="footer-info text-center mt-4">
                    ...
                    <p>
                        Главный редактор - Серебренникова Нина Михайловна,&nbsp;<a href="mailto:cnm@2x2.su" class="gl-red">cnm@2x2.su.</a>
                    </p>
...
<div id="loader-wrapper">
    <div id="like-success" class="alert alert-success">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eos, inventore.</div>
    <div id="like-error" class="alert alert-danger">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eos, inventore.</div>
